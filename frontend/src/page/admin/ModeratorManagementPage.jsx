...
const ModeratorManagementPage = () => {
    ...
    const onSearch = (value) => {
      let searchResult = dataSource.filter((staff) => staff.email.includes(value));
      useEffect
    };
        ...
        },
        {
          ...
          },
          {
            ...
            render: (_, record) => {
              return (
                <Space size="large">
                  <EyeOutlined style={{color: "#1e81b0"}} onClick={() => {setIsDetailModalOpen(true)}}/>
                  <EditOutlined style={{color: "#e28743"}} onClick={showUpdateModal}/>
                  <MinusCircleOutlined style={{color: "red"}} onClick={showDeleteConfirm}/>
                </Space>
              );
            }
          }
    ...
    <>
        <div style={{  minHeight: "100vh" }}>
            <Row justify='center' align='center' style={{padding: "10px"}}>
                <Search placeholder="Nhập email" allowClear onSearch={onSearch} style={{width: "50%", minWidth: "400px", maxWidth: "600px"}} />
            </Row>
            <Row justify='center' align='center' style={{padding: "2%"}}>
                <Col span={22}>
                    <Col span={4}>
                        <Button block type="primary" htmlType="submit" onClick={() => {setIsCreateModalOpen(true)}} style={{marginBottom: "20px", width: "150px"}} >
                                            Tạo nhân viên
                        </Button>
