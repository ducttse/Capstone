...
export default function moderator(state = initState, action) {
  switch (action.type) {
    // detail
    case types.LOAD_MODERATOR_DETAIL_SUCCESS:
        return {
          ...state,
          data: { 
            ...action.payload,
    ...
    case types.LOAD_MODERATOR_DETAIL_FAIL:
        return {
          ...state,
          data: null,
          isLoadSuccess: false,
    ...
    // update
    case types.UPDATE_MODERATOR_SUCCESS:
        return {
          ...state,
          data: { ...action.payload },
          error: "",
    ...
    case types.UPDATE_MODERATOR_FAIL:
        return {
          ...state,
          error: action.error,
          isSuccess: false,
    ...
    //disable
    case types.DISABLE_MODERATOR_SUCCESS:
        return {
          ...state,
          error: "",
          isSuccess: true,
    ...
    case types.DISABLE_MODERATOR_FAIL:
        return {
          ...state,
          error: action.error,
          loading: false,
    ...
    case types.CLEAR_MODERATOR_MESSAGE:
      return {
        ...state,
        loading: false,
        isLoadSuccess: false,
